...
#if 0
    e_printf("REG_FRFMSB =0x%02x \n", SX1276Read( REG_FRFMSB));
    e_printf("REG_FRFMID =0x%02x \n", SX1276Read( REG_FRFMID));
    e_printf("REG_FRFLSB =0x%02x \n", SX1276Read( REG_FRFLSB));
#endif
}
...
void SX1276SetTx( uint32_t timeout )
{
    ...
    SX1276SetOpMode( RF_OPMODE_TRANSMITTER ); // modefy by junhua
