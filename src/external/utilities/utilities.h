...
/*!
 * \brief This function calculates the CRC-16-CCIT checksum of a memory range.
 * 
 * \param [IN] crc    Initial crc value
 *             start  Pointer to the start of the memory block
 *             end    Pointer to the end of the block. This byte is not 
 *   included in the computed CRC.
 * \retval hexChar Converted hexadecimal character
 */
